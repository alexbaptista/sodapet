...
class DogAnimal extends Animal
{
	...
	*/
	public function __construct($emailAnimal, $statusAnimal, $nameAnimal, $raceAnimal, $genderAnimal, $ageAnimal, $sizeAnimal, $weightAnimal, $deficientAnimal, $deficiencyAnimal, $vaccinatedAnimal, $castratedAnimal, $descriptionAnimal, $imageAnimal1, $imageAnimal2, $imageAnimal3, $imageAnimal4, $imageAnimal5, $imageAnimal6, $videoAnimal1, $videoAnimal2)
	{
		...
		$DogId = OperationAnimal::getLastId();
		$idAnimal = $DogId[0] + 1;
		/*
	...
	/*
	* Método createAnimal
	* Responsável pela criação no banco de dados de um animal do tipo "CAO"
	*/
	public function createAnimal()
	{
		...
		{	
			...
			// cria uma instrução de INSERT
			$sqlComplement->setEntity('dadosAnimaisCao');
			...
			$sqlComplement->setRowData('urlPerfilAnimal', 'Cao, Cão, Cachorro, Cachorra, Dog, Caozinho, Cãozinho, Cachorrinho, Cachorrinha, Cachorrinhos, Cachorrinhas, Caes, Caẽs, Cachorros, Cachorras');
			...
			STransaction::log("Criando animal CAO '". $this->idAnimal ."' ==> '" . $this->emailAnimal . "' ======> " . $sqlComplement->getInstruction());
			STransaction::log("Criado animal CAO '". $this->idAnimal ."' ==> '" . $this->emailAnimal . "'");
	...
	/*
	* Método updateAnimal
	* Método responsável pela atualização de um animal do tipo CAO
	...
	*/
	public function updateAnimal($SearchidAnimal)
	{
		try
		{
			...
			STransaction::log("Atualizando animal CAO '". $SearchidAnimal ."' ==> '" . $this->emailAnimal . "' ======> " . $sqlComplement->getInstruction());
			STransaction::log("Atualizando animal CAO '". $SearchidAnimal ."' ==> '" . $this->emailAnimal . "'");
